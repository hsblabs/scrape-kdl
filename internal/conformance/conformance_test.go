...
func TestManifestSuiteSelection(t *testing.T) {
	...
	tests := []struct {
		...
		{suite: "pr", implementation: "go", job: "core", want: 17},
		{suite: "release", implementation: "go", job: "core", want: 18},
		{suite: "release", implementation: "go", job: "browser-e2e", want: 1},
		{suite: "typescript-core", implementation: "typescript", job: "core", want: 18},
