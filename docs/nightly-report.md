...
- Audit declared transform origin, symbol, and name metadata for runtime ambiguity.
- Audit collection selector and output member identifier metadata against schema/compiler invariants.
- Audit external transform symbol structure before registry lookup.
