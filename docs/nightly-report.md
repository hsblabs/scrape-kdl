...
- Audit workflow selector/key/value structural constraints that adapters otherwise receive unchecked from malformed IR.
- Audit value-source raw-type metadata against the compiler and schema contracts before source operations.
